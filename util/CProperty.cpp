...
std::string PropertyUtil::getPropery(PropertyMapT &map,std::string key)
{
...
int main()  
{
	...
	std::string str;
	if(str.empty()){
		std::cout<<"str is empty "<<str<<std::endl;
	}
	std::cout<<"str = "<<str<<std::endl;


	PropertyUtil::PropertyMapT pt;
	PropertyUtil::read("UpNodeAddress.properties",pt);
	PropertyUtil::print(std::cout,pt);
	std::string up_address = PropertyUtil::getPropery(pt,"up_address");
	std::cout<<"up_address: "<<up_address<<std::endl;  
	char buf[1000]; 
